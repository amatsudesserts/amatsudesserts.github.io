...
app.config(["$stateProvider", "$urlRouterProvider", "localStorageServiceProvider", "cfpLoadingBarProvider", function(a, b, c, d) {
  ...
  var d = {
    apiKey: "AIzaSyBCrH759tLxUQtLWs3Vm3byLuAuAkWTC7Y",
    authDomain: "amatsudesserts-fb.firebaseapp.com",
    databaseURL: "https://amatsudesserts-fb.firebaseio.com",
    storageBucket: "amatsudesserts-fb.appspot.com"
  };
  c.initializeApp(d)
